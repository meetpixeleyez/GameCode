                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    ...
                                    <x-image-uploader class="w-100" :imagePath="getImage(getFilePath('seo') . '/' . @$seo->data_values->image, 
                                        getFileSize('seo'))" :size="getFileSize('seo')" :required="false" name="image_input" />
                                </div>
                            </div>
