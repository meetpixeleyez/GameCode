                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Trending Products Count')</label>
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="form-group">
                                    <label>@lang('Preview Video File Size')</label>
                                    <div class="input-group">
                                        <input class="form-control" type="number" name="preview_video_size" required
                                               value="{{ getAmount(gs('preview_video_size')) }}">
                                        <span class="input-group-text">@lang('MB')</span>
                                    </div>
                                    <em class="text--primary text--small"><i class="las la-info-circle"></i>
                                        @lang('Maximum file size for preview video')</em>
                                </div>
                            </div>
                        </div>
