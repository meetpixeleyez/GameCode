...
<div class="sidebar bg--dark">
    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{route('admin.dashboard')}}" class="sidebar__main-logo"><img src="https://readygamecode.com/assets/images/logo_icon/logo_dark.png" alt="image"></a>
        </div>
        ...
        <div class="version-info text-center text-uppercase">
            <span class="text--primary">Ready Game Code</span>
