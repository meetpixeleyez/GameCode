                                        ...
                                        <td data-label="Action">
                                            <div class="btn-group dropend">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" class="dropdown-item editBtn text--dark"
                                                    ...
                                                    <a href="{{ route('admin.reviewer.login', $reviewer->id) }}"
                                                        target="_blank" class="dropdown-item text--dark">
                                                        <i class="las la-sign-in-alt"></i>
                                                        <span class="text--dark">@lang('Login')</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
