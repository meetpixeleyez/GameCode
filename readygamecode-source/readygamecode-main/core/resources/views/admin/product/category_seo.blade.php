...
@section('panel')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.category.update.seo', $data->id) }}"
                            ...
                            <div class="col-xl-4">
                                <div class="form-group">
                                    <label>@lang('SEO Image')</label>
                                        <x-image-uploader class="w-100" :imagePath="getImage(getFilePath('category_seo') . '/' . @$data->seo_content->image, getFileSize('category_seo'))" 
                                            :size="getFileSize('category_seo')" :required="false" name="image" />
                                </div>
                            </div>
