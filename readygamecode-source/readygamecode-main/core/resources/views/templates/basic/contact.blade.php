...
@section('meta_title', gs()->siteName(__('Contact Us')))
@section('meta_description', __(@$contactContent->subheading_one ?? 'Contact our support team for help with Unity game source code purchases, downloads, and marketplace questions.'))
@section('meta_keywords', 'contact, support, game source code help, unity marketplace support')
@section('meta_image', frontendImage('contact_us', @$contactContent->image, '530x700'))
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-5">
                    <div class="contact-thumb d-none d-lg-block">
                        <img
                            src="{{ frontendImage('contact_us' , @$contactContent->image, '530x700') }}" />
                    </div>
                </div>
            </div>
        </div>
