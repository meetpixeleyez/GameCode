                        ...
                        <div class="row justify-content-center gy-sm-4 gy-3">
                            <div class="col-md-6">
                                <div class="payment-system-list is-scrollable gateway-option-list p-0">
                                    <label for="account-balance" class="payment-item gateway-option">
                                        ...
                                        <div class="payment-item__thumb">
                                            <img class="payment-item__thumb-img"
                                                src="{{ getImage('assets/images/avatar.png') }}" alt="@lang('payment-thumb')">
                                        </div>
                                        <input class="payment-item__radio gateway-input" id="account-balance" hidden
                            ...
                            <div class="col-md-6">
                                <div class="payment-system-list p-3">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                ...
                                                <input type="text" class="form-control form--control amount"
                                                    ...
                                                    value="{{ old('amount', $amount) }}" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <hr class="my-4">
                                    ...
                                    <div class="info-text pt-2">
                                        <p class="text fs-14">@lang('Ensuring your funds grow safely through our secure deposit process with world-class payment options.')</p>
                                    </div>
                                </div>
                            </div>
                        </div>
