            ...
            $('.notice').append(`
                <div class="col-12">
                    <div class="alert alert--danger" role="alert">
                        <h4 class="alert-heading text--danger mb-2 fs-18">@lang('Please Allow / Reset Browser Notification') <i class='las la-bell'></i></h4>
                        <p class="fs-16">@lang('If you want to get push notification then you have to allow notification from your browser')</p>
                    </div>
                </div>
            `);
        }
