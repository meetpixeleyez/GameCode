...
class LoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // Store current session ID before login for cart transfer
        $currentSessionId = session()->getId();
        session()->put('pre_login_session_id', $currentSessionId);
        ...
        // If coming from checkout, redirect back to checkout on failed login
        if (session()->has('checkout_return_url')) {
    ...
    public function authenticated(Request $request, $user)
    {
        ...
        // Check for checkout return URL first
    ...
    private function transferCartItemsToUser($user)
    {
        ...
        $preLoginSessionId = session()->get('pre_login_session_id');
        
        if (!$preLoginSessionId) {
            return;
        }
        
        // Get cart items from the pre-login session
        $sessionCartItems = \App\Models\Cart::where('session_id', $preLoginSessionId)->get();
        ...
        // Clear the pre-login session ID
